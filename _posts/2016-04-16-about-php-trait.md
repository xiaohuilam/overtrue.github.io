...
其实说通俗一点，就是能把重复的**方法**拆分出去到一个文件，通过 `use`  引入以达到代码复用的目的。
...
一个公司有很多种产品：电视，电脑与鼠标垫，卡通手办等。其中鼠标垫与卡通手办是非卖器，只用于赠送。

那么这里的 “可卖性” 就是一个特性，非卖品是没有价格的。所以我们便可以抽象出 “可卖性”  这个 Trait 来：
